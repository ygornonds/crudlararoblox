...
@endif
            ...
            <div class="mb-4">
                ...
                <input type="text" class="w-full bg-gray-700 text-gray-300 border border-gray-600 rounded px-4 py-2 mt-2" id="nome" name="nome" value="{{ $categoria->nome }}" placeholder="Insira o nome" >
            </div>
