...
@endif
            ...
            <div class="mb-4">
                ...
                <input type="text" class="w-full bg-gray-700 text-gray-300 border border-gray-600 rounded px-4 py-2 mt-2" id="nome" placeholder="Insira o nome" name="nome" >
            </div>

            <div class="mb-4">
                <label for="id_categoria" class="block text-gray-200 text-sm font-semibold">Categoria:</label>
                <select name="id_categoria" id="id_categoria" class="w-full bg-gray-700 text-gray-300 border border-gray-600 rounded px-4 py-2 mt-2" >
            ...
            <div class="mb-4">
                ...
                <select name="id_criador" id="id_criador" class="w-full bg-gray-700 text-gray-300 border border-gray-600 rounded px-4 py-2 mt-2" >
